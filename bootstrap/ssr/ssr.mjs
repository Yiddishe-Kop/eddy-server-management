...
import { ssrRenderAttrs, ssrRenderList, ssrRenderStyle, renderToString } from "@vue/server-renderer";
...
var ci = Object.prototype,
    ia = ci.hasOwnProperty,
    sa = ci.propertyIsEnumerable,
    aa = En(
        (function () {
            return arguments;
        })()
...
var fi = typeof exports == "object" && exports && !exports.nodeType && exports,
    Tn = fi && typeof module == "object" && module && !module.nodeType && module,
    ua = Tn && Tn.exports === fi,
    xn = ua ? ve.Buffer : void 0,
    ca = xn ? xn.isBuffer : void 0,
    da = ca || la;
const yr = da;
...
function Rr(e, t) {
    var r = typeof e;
    return (t = t != null ? t : fa), !!t && (r == "number" || (r != "symbol" && pa.test(e))) && e > -1 && e % 1 == 0 && e < t;
}
...
var pi = typeof exports == "object" && exports && !exports.nodeType && exports,
    gt = pi && typeof module == "object" && module && !module.nodeType && module,
    Na = gt && gt.exports === pi,
    lr = Na && li.process,
    Va = (function () {
        try {
...
function za(e, t) {
    var r = M(e),
        ...
        s = !r && !n && !i && hi(e),
        a = r || n || i || s,
        o = a ? Us(e.length, String) : [],
        l = o.length;
    for (var u in e)
        (t || Wa.call(e, u)) &&
            !(
                a &&
                (u == "length" || (i && (u == "offset" || u == "parent")) || (s && (u == "buffer" || u == "byteLength" || u == "byteOffset")) || Rr(u, l))
            ) &&
            o.push(u);
    return o;
}
...
function eo(e) {
    if (!Xa(e)) return Qa(e);
    var t = [];
    for (var r in Object(e)) Za.call(e, r) && r != "constructor" && t.push(r);
    return t;
}
function J(e) {
    var t = typeof e;
...
const Mt = ref(0),
    ...
    $e = typeof window > "u";
function fo(e, t, r) {
    $e || window.addEventListener("popstate", po.bind(this)),
        Object.keys(t).length > 0 && Mt.value++,
        (tt[ie.value] = new yi(ie.value)),
        Hr(r),
        Gt(r.head),
        Ur(e);
    const n = $e ? "" : location.href,
        i = Dr(n, r.head, e, t, {}, ie.value, Mt.value, r.persistentLayout);
    bi(i);
}
function po(e) {
    e.state &&
        ...
        (zt.value = {}),
        (Gr.value = {}),
        (Nr.value = R.value.persistentLayoutKey),
        Gt(R.value.head),
        Ur(R.value.html, R.value.rememberedState.scrollY),
        ye("history:popped-state", R.value.url));
}
...
const ur = ref(0),
    Nr = ref(null);
function vo(e) {
    const t = URL.createObjectURL(e.data),
        r = e.headers["content-disposition"].split("filename=")[1],
...
function go(e, t, r) {
    ...
    if (
        (J((g = e.data) == null ? void 0 : g.splade) ||
            console.error("The response is not a Splade response. Did you use the Splade Middleware on this route?"),
        e.data.splade.lazy || e.data.splade.rehydrate)
    )
        return;
    e.data.splade.modal && !e.data.splade.modalTarget && ae.value++;
    const i = Nr.value;
    if ((Hr(e.data.splade), Gt(e.data.splade.head), n === R.value.url && (t = true), e.data.splade.modal)) return Ai(e.data.html, e.data.splade.modal);
    if (e.data.splade.preventRefresh) return;
    (ae.value = 0), (zt.value = {});
    let s = e.data.html,
        a = e.data.dynamics;
    const o = Object.keys(R.value.dynamics).length > 0,
    ...
    t
        ? (l &&
          ...
          (!l || !o) && (s += `<!-- ${ur.value} -->`))
        : (l && Mt.value++, (!l || !o) && (ie.value++, (tt[ie.value] = tt[ie.value] || new yi(ie.value))));
    let u = e.data.splade.persistentLayout && i === e.data.splade.persistentLayout,
        c = 0;
    !$e && e.data.splade.preserveScroll && (c = window.scrollY), Ur(u ? R.value.html : s, c, !t && !e.data.splade.preventViewTransition);
    const v = Dr(
        n,
        e.data.splade.head,
        u ? R.value.html : s,
...
const wi = ref({}),
    Si = (e) => wi.value[e],
    bo = (e) => Object.keys(Si.value[e]).length > 0,
    Oi = ref({}),
    wo = (e) => Oi.value[e],
    $i = ref({}),
    So = (e) => $i.value[e],
...
const Ei = ref({});
function Hr(e) {
    (Nr.value = e.persistentLayout),
        (Ei.value = e.shared ? e.shared : {}),
        ($i.value[ae.value] = e.flash ? e.flash : {}),
        (Oi.value[ae.value] = e.head ? e.head : {}),
        oo(e.toasts ? e.toasts : [], (t) => {
            rt.value.push(t);
        }),
    ...
    const a = ne({
        ...
        onUploadProgress: (o) => {
            r instanceof FormData &&
                ((o.percentage = Math.round((o.loaded / o.total) * 100)),
                ye("internal:request-progress", { url: e, method: t, data: r, headers: n, replace: i, progress: o }));
        },
    });
    return (
        a
            ...
            .catch(async (o) => {
                if ((ye("internal:request-error", { url: e, method: t, data: r, headers: n, replace: i, error: o }), !o.response)) return;
                const l = o.response;
                if (l.status == 409 && l.headers["x-splade-redirect-away"]) return (window.location = l.headers["x-splade-redirect-away"]);
                let u = {};
                ...
                } else u = l.data.splade;
                u && !u.lazy && !u.rehydrate && Hr(u), l.status != 422 && Pi(l.data.html ? l.data.html : l.data);
            }),
        a
    );
}
...
const ue = {
        ...
        setup(e) {
            ...
            return (
                watch(() => t.html, n, { immediate: true }),
                (i, s) => (e.html ? (openBlock(), createBlock(unref(r), { key: 0 })) : createCommentVNode("", true))
            );
        },
    },
    Vo = {
        ...
        setup(e, { emit: t }) {
            ...
            function i() {
                ...
                const l = n.value;
                if (!l.contentWindow) throw new Error("iframe not yet ready.");
                l.contentWindow.document.open(),
                    l.contentWindow.document.write(o.outerHTML),
    ...
    Ho = {
        ...
        setup(e) {
            ...
            const r = ref(),
                ...
                s = ref(null),
                a = ref(true),
                o = inject("$spladeOptions") || {},
                l = computed(() =>
                    p.currentStack.value < 1
                        ? []
                        : {
                              filter: "blur(4px)",
            ...
            p.setOnHead((h2) => {
                ...
                if (!p.isSsr) {
                    ...
                    if (
                        ...
                        (m = document.querySelector('link[rel="canonical"]')) == null || m.remove(),
                        h2.canonical)
                    ) {
                    ...
                    nextTick(() => {
                        ...
                        o.transform_anchors &&
                            [...document.querySelectorAll("a")].forEach((d) => {
                                d.href == "" ||
                                    d.href.charAt(0) == "#" ||
                                    (d.__vnode.dynamicProps === null &&
                                        (d.hasAttribute("download") ||
            ...
            return (
                p.setOnHtml((h2, m, d) => {
                    if (!p.isSsr && document.startViewTransition && o.view_transitions && d) return document.startViewTransition(() => f(h2, m));
                    f(h2, m);
                }),
                p.setOnModal(function (h2, m) {
                    n.value[p.currentStack.value] && (a.value = false),
                        (n.value[p.currentStack.value] = { html: h2, type: m }),
                        nextTick(() => {
                            a.value = true;
                        });
                }),
                ...
                p.init(t.initialHtml, t.initialDynamics, t.initialSpladeData),
                onMounted(() => {
                    if (p.isSsr) return;
                            ...
                            renderList(
                                ...
                                (d) => (
                                    ...
                                    createBlock(
                                        ...
                                        null,
                                        8,
                                        ["type", "html", "stack", "on-top-of-stack", "animate", "onClose"]
                                    )
                                )
                            ),
                            128
...
function Kt(e, t) {
    for (var r = e.length; r--; ) if (Kr(e[r][0], t)) return r;
    return -1;
}
...
var Vl = 1 / 0,
    Pn = ke ? ke.prototype : void 0,
    qn = Pn ? Pn.toString : void 0;
function Qt(e) {
    if (typeof e == "string") return e;
    if (M(e)) return Fi(e, Qt) + "";
    if (Xt(e)) return qn ? qn.call(e) : "";
    var t = e + "";
...
var Dt = ((e) => ((e[(e.None = 0)] = "None"), (e[(e.RenderStrategy = 1)] = "RenderStrategy"), (e[(e.Static = 2)] = "Static"), e))(Dt || {}),
    Ce = ((e) => ((e[(e.Unmount = 0)] = "Unmount"), (e[(e.Hidden = 1)] = "Hidden"), e))(Ce || {});
function Z({ visible: e = true, features: t = 0, ourProps: r, theirProps: n, ...i }) {
    var s;
    let a = Ri(n, r),
        o = Object.assign(i, { props: a });
    if (e || (t & 2 && a.static)) return dr(o);
    if (t & 1) {
...
function dr({ props: e, attrs: t, slots: r, slot: n, name: i }) {
    var s, a;
    let { as: o, ...l } = Bi(e, ["unmount", "static"]),
        u = (s = r.default) == null ? void 0 : s.call(r, n),
        c = {};
    if (n) {
        let v = false,
            g = [];
        for (let [f, h2] of Object.entries(n)) typeof h2 == "boolean" && (v = true), h2 === true && g.push(f);
        v && (c["data-headlessui-state"] = g.join(" "));
    }
    if (o === "template") {
        if (((u = Li(u != null ? u : [])), Object.keys(l).length > 0 || Object.keys(t).length > 0)) {
            let [v, ...g] = u != null ? u : [];
            if (!Wl(v) || g.length > 0)
                throw new Error(
                    [
                        ...
                        Object.keys(l)
                            ...
                            .map((m) => m.trim())
                            .filter((m, d, b) => b.indexOf(m) === d)
                            .sort((m, d) => m.localeCompare(d))
                            .map((m) => `  - ${m}`).join(`
`),
                        "",
...
`)
            ...
            let f = Ri((a = v.props) != null ? a : {}, l),
                h2 = cloneVNode(v, f);
            for (let m in f) m.startsWith("on") && (h2.props || (h2.props = {}), (h2.props[m] = f[m]));
            return h2;
        }
...
var Jl = Object.defineProperty,
    Ql = (e, t, r) => (t in e ? Jl(e, t, { enumerable: true, configurable: true, writable: true, value: r }) : (e[t] = r)),
    Cn = (e, t, r) => (Ql(e, typeof t != "symbol" ? t + "" : t, r), r);
class Yl {
    constructor() {
...
var qe = ((e) => (
    ...
    Di = ((e) => ((e[(e.Error = 0)] = "Error"), (e[(e.Overflow = 1)] = "Overflow"), (e[(e.Success = 2)] = "Success"), (e[(e.Underflow = 3)] = "Underflow"), e))(
        Di || {}
    ),
    Zl = ((e) => ((e[(e.Previous = -1)] = "Previous"), (e[(e.Next = 1)] = "Next"), e))(Zl || {});
function eu(e = document.body) {
    return e == null
        ? []
        : Array.from(e.querySelectorAll(br)).sort((t, r) => Math.sign((t.tabIndex || Number.MAX_SAFE_INTEGER) - (r.tabIndex || Number.MAX_SAFE_INTEGER)));
}
var Ni = ((e) => ((e[(e.Strict = 0)] = "Strict"), (e[(e.Loose = 1)] = "Loose"), e))(Ni || {});
function tu(e, t = 0) {
    var r;
    return e === ((r = Tt(e)) == null ? void 0 : r.body)
        ? false
        : fe(t, {
              [0]() {
                  return e.matches(br);
...
function Lt(e, t, { sorted: r = true, relativeTo: n = null, skipElements: i = [] } = {}) {
    var s;
    let a = (s = Array.isArray(e) ? (e.length > 0 ? e[0].ownerDocument : document) : e == null ? void 0 : e.ownerDocument) != null ? s : document,
        o = Array.isArray(e) ? (r ? su(e) : e) : eu(e);
...
function au(e, t, r = computed(() => true)) {
    function n(s, a) {
        if (!r.value || s.defaultPrevented) return;
        let o = a(s);
        ...
        for (let u of l) {
            ...
            if ((c != null && c.contains(o)) || (s.composed && s.composedPath().includes(c))) return;
        }
    ...
    fr(
        ...
        fr("blur", (s) => n(s, () => (window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null)), true);
}
var Nt = ((e) => ((e[(e.None = 1)] = "None"), (e[(e.Focusable = 2)] = "Focusable"), (e[(e.Hidden = 4)] = "Hidden"), e))(Nt || {});
let wr = defineComponent({
    name: "Hidden",
...
let pt = Object.assign(
        defineComponent({
            ...
            setup(e, { attrs: t, slots: r, expose: n }) {
                ...
                let s = computed(() => Tt(i)),
                    a = ref(false);
                onMounted(() => (a.value = true)),
                    onUnmounted(() => (a.value = false)),
                    fu(
                        { ownerDocument: s },
                        computed(() => a.value && !!(e.features & 16))
                    );
                let o = pu(
                    { ownerDocument: s, container: i, initialFocus: computed(() => e.initialFocus) },
                    computed(() => a.value && !!(e.features & 2))
                );
                hu(
                    { ownerDocument: s, container: i, containers: e.containers, previousActiveElement: o },
                    computed(() => a.value && !!(e.features & 8))
                );
                let l = uu();
                function u(f) {
                    let h2 = D(i);
                ...
                function g(f) {
                    ...
                    m instanceof HTMLElement &&
                        ...
                        (zi(h2, m) ||
                            (c.value
                                ? Lt(D(i), fe(l.value, { [vt.Forwards]: () => qe.Next, [vt.Backwards]: () => qe.Previous }) | qe.WrapAround, {
                                      relativeTo: f.target,
                                  })
                                : f.target instanceof HTMLElement && We(f.target)));
                }
                return () => {
                    let f = {},
                        h$1 = { ref: i, onKeydown: v, onFocusout: g },
                        { features: m, initialFocus: d, containers: b, ...O } = e;
                    return h(Fragment, [
                        !!(m & 4) && h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Nt.Focusable }),
                        Z({ ourProps: h$1, theirProps: { ...t, ...O }, slot: f, attrs: t, slots: r, name: "FocusTrap" }),
                        !!(m & 4) && h(wr, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: u, features: Nt.Focusable }),
                    ]);
                };
            },
...
cu(() => {
    function e(t) {
        t.target instanceof HTMLElement &&
            ...
            He[0] !== t.target &&
            (He.unshift(t.target), (He = He.filter((r) => r != null && r.isConnected)), He.splice(10));
    }
    window.addEventListener("click", e, { capture: true }),
        window.addEventListener("mousedown", e, { capture: true }),
        window.addEventListener("focus", e, { capture: true }),
        document.body.addEventListener("click", e, { capture: true }),
        document.body.addEventListener("mousedown", e, { capture: true }),
        document.body.addEventListener("focus", e, { capture: true });
});
function du(e) {
    let t = ref(He.slice());
    return (
...
function pu({ ownerDocument: e, container: t, initialFocus: r }, n) {
    let i = ref(null),
        s = ref(false);
    return (
        onMounted(() => (s.value = true)),
        onUnmounted(() => (s.value = false)),
        onMounted(() => {
            watch(
                [t, r, n],
                (a, o) => {
                    if (a.every((u, c) => (o == null ? void 0 : o[c]) === u) || !n.value) return;
                    let l = D(t);
                    l &&
                        Hi(() => {
                            var u, c;
                            if (!s.value) return;
                            let v = D(r),
                                g = (u = e.value) == null ? void 0 : u.activeElement;
                            if (v) {
                                if (v === g) {
                                    i.value = g;
                                    return;
                            ...
                            v ? We(v) : Lt(l, qe.First | qe.NoScroll) === Di.Error && console.warn("There are no focusable elements inside the <FocusTrap />"),
                                (i.value = (c = e.value) == null ? void 0 : c.activeElement);
                        });
                },
...
function zi(e, t) {
    for (let r of e) if (r.contains(t)) return true;
    return false;
}
...
function Fn(e, t = ref(true)) {
    watchEffect((r) => {
        ...
        r(function () {
            ...
            if ((o === 1 ? ht.delete(i) : ht.set(i, o - 1), o !== 1)) return;
            let l = pr.get(i);
            l &&
                (l["aria-hidden"] === null ? i.removeAttribute("aria-hidden") : i.setAttribute("aria-hidden", l["aria-hidden"]),
                (i.inert = l.inert),
                pr.delete(i));
        });
        let s = (n = ht.get(i)) != null ? n : 0;
        ht.set(i, s + 1),
            s === 0 && (pr.set(i, { "aria-hidden": i.getAttribute("aria-hidden"), inert: i.inert }), i.setAttribute("aria-hidden", "true"), (i.inert = true));
    });
}
...
let Xi = defineComponent({
        ...
        setup(e, { slots: t, attrs: r }) {
            let n = ref(null),
                ...
                s = mu(),
                a = inject(Ki, null),
                o = ref(s === true || a == null ? vu(n.value) : a.resolveTarget());
            return (
                watchEffect(() => {
...
defineComponent({
    name: "Description",
    props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Ye()}` } },
    setup(e, { attrs: t, slots: r }) {
        let n = wu();
        return (
            onMounted(() => onUnmounted(n.register(e.id))),
            () => {
                let { name: i = "Description", slot: s = ref({}), props: a = {} } = n,
                    { id: o, ...l } = e,
                    u = { ...Object.entries(a).reduce((c, [v, g]) => Object.assign(c, { [v]: unref(g) }), {}), id: o };
    ...
    return (
        watch(
            ...
            ([s, a], [o], l) => {
                ...
                let u = false;
                l(() => {
                    u || (Ue.dispatch("POP", o != null ? o : s, r), (u = true));
                });
            },
            { immediate: true }
        ),
...
let qt = "DC8F892D-2EBD-447C-A4C8-A03058436FF4",
    en = defineComponent({
        name: "Dialog",
        inheritAttrs: false,
        props: {
            ...
            open: { type: [Boolean, String], default: qt },
            initialFocus: { type: Object, default: null },
            id: { type: String, default: () => `headlessui-dialog-${Ye()}` },
        },
        emits: { close: (e) => true },
        setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
            var s;
            let a = ref(false);
            onMounted(() => {
                a.value = true;
            ...
            let o = ref(0),
                l = Zr(),
                u = computed(() => (e.open === qt && l !== null ? (l.value & G.Open) === G.Open : e.open)),
                c = ref(null),
                v = ref(null),
                g = computed(() => Tt(c));
            if ((i({ el: c, $el: c }), !(e.open !== qt || l !== null))) throw new Error("You forgot to provide an `open` prop to the `Dialog`.");
            if (typeof u.value != "boolean")
                throw new Error(
                    `You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${u.value === qt ? void 0 : e.open}`
                );
            let f = computed(() => (a.value && u.value ? 0 : 1)),
                h$1 = computed(() => f.value === 0),
                m = computed(() => o.value > 1),
                d = inject($r, null) !== null,
                b = computed(() => (m.value ? "parent" : "leaf")),
                O = computed(() => (l !== null ? (l.value & G.Closing) === G.Closing : false)),
                A = computed(() => (d || O.value ? false : h$1.value)),
                S = computed(() => {
                    var E, T, I;
                    return (I = Array.from((T = (E = g.value) == null ? void 0 : E.querySelectorAll("body > *")) != null ? T : []).find((C) =>
                        C.id === "headlessui-portal-root" ? false : C.contains(D(v)) && C instanceof HTMLElement
                    )) != null
                        ? I
                        : null;
                });
            Fn(S, A);
            let $ = computed(() => (m.value ? true : h$1.value)),
                w = computed(() => {
                    var E, T, I;
                    return (I = Array.from((T = (E = g.value) == null ? void 0 : E.querySelectorAll("[data-headlessui-portal]")) != null ? T : []).find(
                        (C) => C.contains(D(v)) && C instanceof HTMLElement
                    )) != null
                        ? I
                        : null;
                });
            Fn(w, $),
                bu({
                    type: "Dialog",
                    enabled: computed(() => f.value === 0),
                    element: c,
                    onUpdate: (E, T) => {
                        if (T === "Dialog") return fe(E, { [Or.Add]: () => (o.value += 1), [Or.Remove]: () => (o.value -= 1) });
                    },
                });
            let _ = Su({ name: "DialogDescription", slot: computed(() => ({ open: u.value })) }),
                q = ref(null),
                P = {
                    titleId: q,
                    panelRef: ref(null),
            ...
            function k() {
                ...
                return [
                    ...Array.from(
                        (T = (E = g.value) == null ? void 0 : E.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? T : []
                    ).filter(
                        (C) =>
                            !(
                                C === document.body ||
                                ...
                                C.contains(D(v)) ||
                                (P.panelRef.value && C.contains(P.panelRef.value))
                            )
                    ),
                    (I = P.panelRef.value) != null ? I : c.value,
                ];
            }
            ...
            return (
                ...
                () => {
                    let { id: E, open: T, initialFocus: I, ...C } = e,
                        ge = {
                            ...r,
                            ref: c,
                            id: E,
                            role: "dialog",
                            "aria-modal": f.value === 0 ? true : void 0,
                            "aria-labelledby": q.value,
                            "aria-describedby": _.value,
                        },
                        U = { open: f.value === 0 };
                    return h(Sr, { force: true }, () => [
                        h(Xi, () =>
                            h(gu, { target: c.value }, () =>
                                h(Sr, { force: false }, () =>
                                    h(
                                        pt,
                                        {
                                            ...
                                            containers: k,
                                            features: h$1.value
                                                ? fe(b.value, { parent: pt.features.RestoreFocus, leaf: pt.features.All & ~pt.features.FocusLock })
                                                : pt.features.None,
                                        },
                                        () =>
                                            Z({
...
defineComponent({
    name: "DialogOverlay",
    props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-overlay-${Ye()}` } },
    setup(e, { attrs: t, slots: r }) {
        ...
        return () => {
            let { id: s, ...a } = e;
            return Z({
                ourProps: { id: s, "aria-hidden": true, onClick: i },
                theirProps: a,
...
defineComponent({
    name: "DialogBackdrop",
    props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${Ye()}` } },
    inheritAttrs: false,
    setup(e, { attrs: t, slots: r, expose: n }) {
        let i = xt("DialogBackdrop"),
            s = ref(null);
        return (
            n({ el: s, $el: s }),
            onMounted(() => {
            ...
            () => {
                let { id: a, ...o } = e,
                    l = { id: a, ref: s, "aria-hidden": true };
                return h(Sr, { force: true }, () =>
                    h(Xi, () =>
                        Z({ ourProps: l, theirProps: { ...t, ...o }, slot: { open: i.dialogState.value === 0 }, attrs: t, slots: r, name: "DialogBackdrop" })
                    )
                );
            }
        );
...
let tn = defineComponent({
    name: "DialogPanel",
    props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Ye()}` } },
    setup(e, { attrs: t, slots: r, expose: n }) {
        ...
        return () => {
            let { id: a, ...o } = e,
                l = { id: a, ref: i.panelRef, onClick: s };
...
defineComponent({
    name: "DialogTitle",
    props: { as: { type: [Object, String], default: "h2" }, id: { type: String, default: () => `headlessui-dialog-title-${Ye()}` } },
    setup(e, { attrs: t, slots: r }) {
...
function Pu(e) {
    let t = { called: false };
    return (...r) => {
        if (!t.called) return (t.called = true), e(...r);
    };
}
function hr(e, ...t) {
...
let Zi = Dt.RenderStrategy,
    lt = defineComponent({
        ...
        emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true },
        setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
            let s = ref(0);
            function a() {
            ...
            if (!Fu() && Xl()) return () => h(ut, { ...e, onBeforeEnter: a, onAfterEnter: o, onBeforeLeave: l, onAfterLeave: u }, n);
            let c = ref(null),
                v = computed(() => (e.unmount ? Ce.Unmount : Ce.Hidden));
            i({ el: c, $el: c });
            let { show: g, appear: f } = ku(),
                { register: h$1, unregister: m } = Lu(),
                d = ref(g.value ? "visible" : "hidden"),
                b = { value: true },
                O = Ye(),
                A = { value: false },
                S = Yi(() => {
            ...
            return (
                ...
                provide(nn, S),
                Kl(computed(() => fe(d.value, { visible: G.Open, hidden: G.Closed }) | s.value)),
                () => {
                    let { appear: F, show: E, enter: T, enterFrom: I, enterTo: C, entered: ge, leave: U, leaveFrom: ct, leaveTo: It, ...Ie } = e,
                        Ze = { ref: c },
                        Ae = { ...Ie, ...(f.value && g.value && Et.isServer ? { class: normalizeClass([r.class, Ie.class, ...$, ...w]) } : {}) };
                    return Z({
                        theirProps: Ae,
                        ourProps: Ze,
                        slot: {},
    ...
    ut = defineComponent({
        ...
        setup(e, { emit: t, attrs: r, slots: n }) {
            let i = Zr(),
                s = computed(() => (e.show === null && i !== null ? (i.value & G.Open) === G.Open : e.show));
            watchEffect(() => {
                if (![true, false].includes(s.value)) throw new Error('A <Transition /> is used but it is missing a `:show="true | false"` prop.');
            });
            let a = ref(s.value ? "visible" : "hidden"),
                o = Yi(() => {
                    a.value = "hidden";
                }),
                l = ref(true),
                u = { show: s, appear: computed(() => e.appear || !l.value) };
            return (
                onMounted(() => {
                    watchEffect(() => {
                ...
                provide(rn, u),
                () => {
                    let c = Bi(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]),
                        v = { unmount: e.unmount };
                    return Z({
...
const Bu = {
    ...
    computed: {
        ...
        text: function () {
            var e;
            return (e = p.confirmModal.value) != null && e.text
                ? p.confirmModal.value.text
    ...
    methods: {
        ...
        confirm() {
            if (!this.confirmPassword) return this.handleSuccess(null);
            this.submitting = true;
            let e = this.password;
            (this.passwordError = ""),
                ne
                    .post(
                        this.confirmPasswordRoute,
                        { password: e },
                        {
                            headers: {
                    ...
                    .catch((t) => {
                        t.response.status === 422
                            ? (this.passwordError = t.response.data.errors.password[0])
...
function es(e, t) {
    t = Yr(t, e);
    for (var r = 0, n = t.length; e != null && r < n; ) e = e[$t(t[r++])];
...
function er(e, t, r) {
    var n,
        ...
        v = false,
        g = true;
    if (typeof e != "function") throw new TypeError(ec);
    ...
    function $() {
        ...
        if (((n = arguments), (i = this), (l = w), _)) {
            if (o === void 0) return h2(l);
            if (v) return clearTimeout(o), (o = setTimeout(b, t)), f(l);
        }
...
const nc = {
        ...
        methods: {
            performRequest() {
                ...
                Object.keys(this.request).length > 0 && (t.data = this.request),
                    ne(t)
                        .then((r) => {
            ...
            return (
                onMounted(() => {
                    (r.value = (s) => {
                        ...
                        document.addEventListener("click", r.value),
                        document.addEventListener("touchstart", r.value),
                        t.closeOnEscape &&
                            ((i.value = (s) => {
                ...
                onBeforeUnmount(() => {
                    document.removeEventListener("click", r.value),
                        document.removeEventListener("touchstart", r.value),
                        t.closeOnEscape && document.removeEventListener("keydown", i.value);
                }),
                (s, a) => (
                    openBlock(),
                    createElementBlock(
...
function it(e, t, r) {
    ...
    var a = Xe(e) ? Q(e) : window,
        o = a.visualViewport,
        l = !ns() && r,
        u = (n.left + (l && o ? o.offsetLeft : 0)) / i,
        c = (n.top + (l && o ? o.offsetTop : 0)) / s,
        v = n.width / i,
        g = n.height / s;
    return {
        width: v,
...
function oc(e) {
    var t = e.getBoundingClientRect(),
        ...
        n = nt(t.height) / e.offsetHeight || 1;
    return r !== 1 || n !== 1;
}
function lc(e, t, r) {
    r === void 0 && (r = false);
    ...
    return (
        (n || (!n && !r)) &&
            ((pe(t) !== "body" || ln(s)) && (o = ac(t)), re(t) ? ((l = it(t, true)), (l.x += t.clientLeft), (l.y += t.clientTop)) : s && (l.x = on(s))),
        {
...
function tr(e) {
    return pe(e) === "html" ? e : e.assignedSlot || e.parentNode || (sn(e) ? e.host : null) || je(e);
}
function ss(e) {
...
function yt(e, t) {
    ...
    var n = ss(e),
        ...
        s = Q(n),
        a = i ? [s].concat(s.visualViewport || [], ln(n) ? n : []) : n,
        o = t.concat(a);
    return i ? o : o.concat(yt(tr(a)));
}
function uc(e) {
    return ["table", "td", "th"].indexOf(pe(e)) >= 0;
}
function Bn(e) {
    return !re(e) || Ee(e).position === "fixed" ? null : e.offsetParent;
}
function cc(e) {
    var t = /firefox/i.test(xr()),
        r = /Trident/i.test(xr());
    if (r && re(e)) {
        var n = Ee(e);
...
function rr(e) {
    for (var t = Q(e), r = Bn(e); r && uc(r) && Ee(r).position === "static"; ) r = Bn(r);
...
var oe = "top",
    ...
    mt = "popper",
    fc = "reference",
    jn = /* @__PURE__ */ nr.reduce(function (e, t) {
...
function Ac(e) {
    var t,
        ...
        s = ze(r.scrollWidth, r.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0),
        a = ze(r.scrollHeight, r.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0),
        o = -n.scrollLeft + on(e),
        l = -n.scrollTop;
    return (
        Ee(i || r).direction === "rtl" && (o += ze(r.clientWidth, i ? i.clientWidth : 0) - s),
        {
            width: s,
            height: a,
            x: o,
...
function Cc(e) {
    var t = yt(tr(e)),
        r = ["absolute", "fixed"].indexOf(Ee(e).position) >= 0,
        n = r && re(e) ? rr(e) : e;
    return Xe(n)
        ? t.filter(function (i) {
...
function Fc(e, t, r, n) {
    var i = t === "clippingParents" ? Cc(e) : [].concat(t),
        s = [].concat(i, [r]),
        a = s[0],
...
function cn(e, t) {
    ...
    var r = t,
        ...
        m = r.padding,
        d = m === void 0 ? 0 : m,
        b = kc(typeof d != "number" ? d : Lc(d, nr)),
        O = g === mt ? fc : mt,
        A = e.rects.popper,
        S = e.elements[h2 ? O : g],
        $ = Fc(Xe(S) ? S : S.contextElement || je(e.elements.popper), l, c, a),
        w = it(e.elements.reference),
        _ = ls({
            reference: w,
            element: A,
            strategy: "absolute",
    ...
    if (g === mt && j) {
        ...
        Object.keys(k).forEach(function (F) {
            var E = [Re, he].indexOf(F) >= 0 ? 1 : -1,
                T = [oe, he].indexOf(F) >= 0 ? "y" : "x";
            k[F] += H[T] * E;
        });
    }
    return k;
        ...
        var c = {
            ...
            f = {
                ...
                setOptions: function (b) {
                    ...
                    return (
                        (c.orderedModifiers = A.filter(function (S) {
                            return S.enabled;
                        })),
                        h2(),
                        f.update()
...
function Bc(e) {
    ...
    return (
        ...
        o && l.addEventListener("resize", r.update, Ft),
        function () {
            s &&
                u.forEach(function (c) {
...
function Vn(e) {
    ...
    if (u) {
        var w = rr(r),
            ...
            q = "clientWidth";
        if (
            (w === Q(r) && ((w = je(r)), Ee(w).position !== "static" && o === "absolute" && ((_ = "scrollHeight"), (q = "scrollWidth"))),
            (w = w),
            i === oe || ((i === we || i === Re) && s === Ot))
        ) {
            S = he;
            var P = v && w === $ && $.visualViewport ? $.visualViewport.height : w[_];
            (m -= P - n.height), (m *= l ? 1 : -1);
        }
        if (i === we || ((i === oe || i === he) && s === Ot)) {
            A = Re;
            var k = v && w === $ && $.visualViewport ? $.visualViewport.width : w[q];
            (f -= k - n.width), (f *= l ? 1 : -1);
        }
    }
    var j = Object.assign(
    ...
    if (((f = H.x), (m = H.y), l)) {
        ...
        return Object.assign(
            ...
            (F[S] = O ? "0" : ""),
            (F[A] = b ? "0" : ""),
            (F.transform = ($.devicePixelRatio || 1) <= 1 ? "translate(" + f + "px, " + m + "px)" : "translate3d(" + f + "px, " + m + "px, 0)"),
            F)
        );
    }
    ...
    if (w) {
        if (s) {
            var F,
                ...
                Pe = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : us(),
                dt = Pe[E],
                At = Pe[T],
                Me = Rt(0, _[I], Ae[I]),
                sr = A ? _[I] / 2 - ct - Me - dt - k.mainAxis : It - Me - dt - k.mainAxis,
                Ss = A ? -_[I] / 2 + ct + Me + At + k.mainAxis : Ie + Me + At + k.mainAxis,
                ar = t.elements.arrow && rr(t.elements.arrow),
                Os = ar ? (S === "y" ? ar.clientTop || 0 : ar.clientLeft || 0) : 0,
                hn = (F = j == null ? void 0 : j[S]) != null ? F : 0,
                $s = C + sr - hn - Os,
                Es = C + Ss - hn,
                mn = Rt(f ? Vt(ge, $s) : ge, C, f ? ze(U, Es) : U);
            (w[S] = mn), (H[S] = mn - C);
        }
        if (o) {
            var vn,
                ...
                gn = De + d[Ts],
                yn = De - d[xs],
                or = [oe, we].indexOf(b) !== -1,
                bn = (vn = j == null ? void 0 : j[$]) != null ? vn : 0,
                wn = or ? gn : De - _[Pt] - q[Pt] - bn + k.altAxis,
                Sn = or ? De + _[Pt] + q[Pt] - bn - k.altAxis : yn,
                On = f && or ? Qc(wn, De, Sn) : Rt(f ? wn : gn, De, f ? Sn : yn);
            (w[$] = On), (H[$] = On - De);
        }
        t.modifiersData[n] = H;
    }
...
function rd(e, t) {
    ...
    var r = t,
        ...
        v = c
            ? o
                ? jn
                : jn.filter(function (h2) {
                      return at(h2) === c;
                  })
            : nr,
        g = v.filter(function (h2) {
    ...
    if (!t.modifiersData[n]._skip) {
        for (
            var i = r.mainAxis,
                ...
                O = b === d,
                A = l || (O || !h2 ? [Bt(d)] : nd(d)),
                S = [d].concat(A).reduce(function (Ae, Pe) {
                    return Ae.concat(
                        Fe(Pe) === un
                            ? rd(t, {
                                  placement: Pe,
...
function ld(e, t, r, n, i, s) {
    ...
    return (
        ...
        createBlock(
            ...
            8,
            ["style", "do", "opened", "ignore-inner-targets"]
        )
    );
}
const ud = /* @__PURE__ */ _e(ad, [["render", ld]]),
    cd = {
        __name: "DynamicHtml",
        props: {
            keepAliveKey: {
        ...
        setup(e) {
            const t = inject("$splade") || {},
                r = inject("$spladeOptions") || {};
            return (n, i) =>
                unref(t).isSsr
                    ? (openBlock(),
                      createBlock(
...
const dd = {
    ...
    fd = {
        ...
        mounted() {
            (this.subscription = this.private ? window.Echo.private(this.channel) : window.Echo.channel(this.channel)),
                this.subscription ? this.bindListeners() : console.error("[Splade Event component] Unable to subscribe to channel: " + this.channel);
        },
        methods: {
            handlePendingVisit() {
            ...
            handlePendingRefresh() {
                this.pendingRefresh &&
                    p.currentStack.value === this.stack &&
                    (p.refresh(this.pendingRefresh.preserveScroll || this.preserveScroll), (this.pendingRefresh = false));
            },
            bindListeners() {
                    ...
                    this.listeners.forEach((e) => {
                        const t = this.subscription.listen(e, (r) => {
                            ...
                            te(r, (v) => {
                                ...
                                o ? (this.pendingVisit = o) : u ? (this.pendingRefresh = { preserveScroll: l }) : this.events.push({ name: e, data: r }),
                                c.length > 0 &&
                                    c.forEach((v) => {
                                        p.pushToast(v);
                                    }),
...
function yd(e, t) {
    ...
    if (r instanceof Te) {
        var n = r.__data__;
        if (!wt || n.length < gd - 1) return n.push([e, t]), (this.size = ++r.size), this;
...
function Ht(e) {
    var t = -1,
        r = e == null ? 0 : e.length;
    for (this.__data__ = new xe(); ++t < r; ) this.add(e[t]);
}
Ht.prototype.add = Ht.prototype.push = wd;
Ht.prototype.has = Sd;
function Od(e, t) {
    for (var r = -1, n = e == null ? 0 : e.length; ++r < n; ) if (t(e[r], r, e)) return true;
    return false;
}
function $d(e, t) {
    return e.has(t);
...
function ds(e, t, r, n, i, s) {
    var a = r & Ed,
        o = e.length,
        l = t.length;
    if (o != l && !(a && l > o)) return false;
    var u = s.get(e),
        c = s.get(t);
    if (u && c) return u == t && c == e;
    var v = -1,
        g = true,
        f = r & Td ? new Ht() : void 0;
    for (s.set(e, t), s.set(t, e); ++v < o; ) {
        var h2 = e[v],
            m = t[v];
        if (n) var d = a ? n(m, h2, v, t, e, s) : n(h2, m, v, e, t, s);
        if (d !== void 0) {
            if (d) continue;
            g = false;
            break;
        ...
        if (f) {
            if (
                !Od(t, function (b, O) {
                    if (!$d(f, O) && (h2 === b || i(h2, b, r, n, s))) return f.push(O);
                })
            ) {
                g = false;
                break;
...
var Ad = 1,
    ...
    Nd = "[object DataView]",
    Wn = ke ? ke.prototype : void 0,
    vr = Wn ? Wn.valueOf : void 0;
function Vd(e, t, r, n, i, s, a) {
    switch (r) {
        ...
        case Bd:
            var l = n & Ad;
            if ((o || (o = Id), e.size != t.size && !l)) return false;
            var u = a.get(e);
            if (u) return u == t;
            (n |= Pd), a.set(e, t);
...
function Zd(e, t, r, n, i, s) {
    var a = r & Jd,
        ...
        u = Gn(t),
        c = u.length;
    if (l != c && !a) return false;
    for (var v = l; v--; ) {
        var g = o[v];
        if (!(a ? g in t : Yd.call(t, g))) return false;
    }
    var f = s.get(e),
        h2 = s.get(t);
    if (f && h2) return f == t && h2 == e;
    var m = true;
    s.set(e, t), s.set(t, e);
    for (var d = a; ++v < l; ) {
        g = o[v];
        var b = e[g],
            O = t[g];
        if (n) var A = a ? n(O, b, g, t, e, s) : n(b, O, g, e, t, s);
    ...
    if (m && !d) {
        ...
        S != $ &&
            "constructor" in e &&
            "constructor" in t &&
            !(typeof S == "function" && S instanceof S && typeof $ == "function" && $ instanceof $) &&
            (m = false);
    }
...
var Xn = "[object Map]",
    ...
    cf = Je(qr),
    Ve = Be;
((Ir && Ve(new Ir(new ArrayBuffer(1))) != Yn) ||
    (wt && Ve(new wt()) != Xn) ||
    (Ar && Ve(Ar.resolve()) != Kn) ||
    (Pr && Ve(new Pr()) != Jn) ||
    (qr && Ve(new qr()) != Qn)) &&
...
function pf(e, t, r, n, i, s) {
    ...
    if (g && !c) return s || (s = new Se()), a || hi(e) ? ds(e, t, r, n, i, s) : Vd(e, t, l, r, n, i, s);
    if (!(r & df)) {
        var f = c && ri.call(e, "__wrapped__"),
            h2 = v && ri.call(t, "__wrapped__");
        if (f || h2) {
            var m = f ? e.value() : e,
                d = h2 ? t.value() : t;
...
function vf(e, t, r, n) {
    ...
    for (e = Object(e); i--; ) {
        var o = r[i];
        if (a && o[2] ? o[1] !== e[o[0]] : !(o[0] in e)) return false;
    }
    for (; ++i < s; ) {
        o = r[i];
        var l = o[0],
            ...
            c = o[1];
        if (a && o[2]) {
            if (u === void 0 && !(l in e)) return false;
        } else {
            var v = new Se();
            if (n) var g = n(u, c, l, e, t, v);
            if (!(g === void 0 ? ir(c, u, hf | mf, n, v) : g)) return false;
        }
    }
    return true;
}
...
const fn = Ff,
    kf = {
        ...
        mounted() {
            ...
            (this.hadExistingFiles = (this.multiple && e.length > 0) || (!this.multiple && e)),
                this.form.$put(this.field, this.multiple ? [] : null),
                this.filepond &&
                    (this.setExisting(e),
                    this.initFilepond(e || []).then(() => {
        ...
        methods: {
            ...
            setOrder() {
                if (!this.multiple || !this.handlesExistingFiles || !this.filepondInstance) return;
                const t = this.filepondInstance.getFiles().filter((n) => !n.getMetadata("identifier")),
                    r = this.filepondInstance.getFiles().map((n) => {
            ...
            loadFilepondPlugins() {
                const e = [];
                return (
                    this.preview && (e.push(import("filepond-plugin-image-exif-orientation")), e.push(import("filepond-plugin-image-preview"))),
                    this.accept.length > 0 && e.push(import("filepond-plugin-file-validate-type")),
                    (this.minFileSize || this.maxFileSize) && e.push(import("filepond-plugin-file-validate-size")),
                    (this.minImageWidth ||
                        this.maxImageWidth ||
                        this.minImageHeight ||
                        this.maxImageHeight ||
                        this.minImageResolution ||
                        this.maxImageResolution) &&
                        e.push(import("filepond-plugin-image-validate-size")),
                    Promise.all(e)
                );
            },
            initFilepond(e) {
                const t = this.inputElement.getAttribute("name"),
                    r = this;
                return new Promise((n) => {
                    import("filepond").then((i) => {
                        const s = Object.assign({}, r.filepond, r.jsFilepondOptions, {
                            oninit() {
                                const a = setInterval(() => {
                                    if (r.filepondInstance.status <= 2) clearInterval(a);
                                    else return;
                                    r.setOrder();
                                    const o = r.filepondInstance.element.querySelector('input[type="file"]');
                                    o.hasAttribute("name") || o.setAttribute("name", t),
                                        r.dusk && r.filepondInstance.element.setAttribute("dusk", r.dusk),
                                        o.setAttribute("data-server", !!r.server),
                                        r.multiple &&
                                            r.filepondInstance.element.addEventListener("moveFile", function (l) {
                            ...
                            onremovefile(a, o) {
                                a ||
                                    (r.handlesExistingFiles &&
                                        (r.multiple
                                            ? r.setExisting(r.form[r.existingField].filter((l) => o.getMetadata("metadata") !== l))
                                            : r.setExisting(null)),
                                    r.removeFile(o.file));
                            },
                            onprocessfile(a, o) {
                                a ||
                                    (r.uploadedFiles.push({
                                        file: o.file,
                                        id: o.serverId,
                                    }),
                                    r.addFiles([o.serverId]),
                                    r.$emit("stop-uploading", [o.id]));
                            },
                            onreorderfiles() {
                                r.setOrder();
                            },
                        });
                        this.hadExistingFiles && (s.files = this.multiple ? e : [e]),
                            this.accept.length > 0 && (s.acceptedFileTypes = this.accept),
                            this.minFileSize && (s.minFileSize = this.minFileSize),
                            this.maxFileSize && (s.maxFileSize = this.maxFileSize),
                            this.minImageWidth && (s.imageValidateSizeMinWidth = this.minImageWidth),
                            this.maxImageWidth && (s.imageValidateSizeMaxWidth = this.maxImageWidth),
                            this.minImageHeight && (s.imageValidateSizeMinHeight = this.minImageHeight),
                            this.maxImageHeight && (s.imageValidateSizeMaxHeight = this.maxImageHeight),
                            this.minImageResolution && (s.imageValidateSizeMinResolution = this.minImageResolution),
                            this.maxImageResolution && (s.imageValidateSizeMaxResolution = this.maxImageResolution),
                            (s.server = {
                                load: (a, o, l, u, c) => {
                            ...
                            this.server &&
                                ((s.server.process = (a, o, l, u, c, v, g) => {
                            ...
                            (s.itemInsertLocation === "before" || s.itemInsertLocation === "after") && (s.itemInsertLocationFreedom = false),
            ...
            removeFile(e) {
                this.server && (e = fn(this.uploadedFiles, (t) => t.file === e).serverId),
                    this.form.$put(this.field, this.multiple ? this.form[this.field].filter((t) => t !== e) : null);
            },
            addFiles(e) {
                if (this.multiple) {
                ...
                } else this.form.$put(this.field, e[0]), this.setExisting(null);
...
const Bf = /* @__PURE__ */ _e(kf, [["render", Rf]]),
    jf = {
        inject: ["stack"],
        computed: {
            values() {
...
function pn(e, t, r) {
    ...
    for (const n in e) Object.prototype.hasOwnProperty.call(e, n) && vs(t, ms(r, n), e[n]);
    return t;
}
function ms(e, t) {
    return e ? e + "[" + t + "]" : t;
...
function vs(e, t, r) {
    if (Array.isArray(r)) return Array.from(r.keys()).forEach((n) => vs(e, ms(t, n.toString()), r[n]));
...
`)
        ...
        mounted() {
            ...
            e || (e = document),
                (this.formElement = e),
                this.missingAttributes.forEach((r) => {
                    let n = "";
                    const i = e.querySelector(`[name="${r}"]`);
                    i
                        ? (n = i.type === "checkbox" ? false : "")
                        : e.querySelector(`[name="${r}[]"]`)
                        ? (n = [])
                        : (e.querySelector(`[name^="${r}."]`) || e.querySelector(`[name^="${r}["]`)) && (n = {}),
                        this.$put(r, n);
                }),
                ...
                this.submitOnChange === true
                    ? this.$watch(
                          "values",
                          () => {
                              this.background && (this.processingInBackground = true),
                                  this.$nextTick(() => (this.debounce ? this.debounceFunction() : this.request(this.background)));
                          },
                          { deep: true }
                      )
                    : M(this.submitOnChange) &&
                      this.submitOnChange.forEach((r) => {
                          this.$watch(
                              `values.${r}`,
                              () => {
                                  this.background && (this.processingInBackground = true),
        ...
        methods: {
            ...
            $addFile(e, t) {
                if (!this.fileponds[e]) return console.log("Filepond instance not found");
            ...
            $fileAsUrl(e) {
                ...
                for (var i = "", s = 0; s < n.responseText.length; s++) i += String.fromCharCode(n.responseText.charCodeAt(s) & 255);
            ...
            submit(e) {
                ...
                if (!this.confirm) return this.request();
                p.confirm(
                    ...
                    .then((t) => {
                        ...
                        this.method.toUpperCase() !== "GET" &&
                            t &&
                            this.$put(se(this.requirePassword) && this.requirePassword ? this.requirePassword : "password", t),
                            this.request();
                    })
                    .catch(() => {});
            },
            async request(e) {
                ...
                await this.$nextTick(),
                    this.background ? (this.processingInBackground = true) : (this.processing = true),
                    (this.response = null),
                ...
                const t = this.values instanceof FormData ? this.values : pn(this.values),
                    r = {};
                this.acceptHeader && (r.Accept = this.acceptHeader),
                    (this.stay || e) && (r["X-Splade-Prevent-Refresh"] = true),
                    this.preserveScroll && (r["X-Splade-Preserve-Scroll"] = true),
                    this.stack > 0 && this.keepModal && ((r["X-Splade-Modal"] = p.stackType(this.stack)), (r["X-Splade-Modal-Target"] = this.stack));
                let n = this.method.toUpperCase();
                n !== "GET" && n !== "POST" && (t.append("_method", n), (n = "POST"));
                const i = (s) => {
                    this.$emit("success", s),
                        this.restoreOnSuccess && this.restore(),
                        this.resetOnSuccess && this.reset(),
                        (this.processing = false),
                        (this.processingInBackground = false),
                        (this.wasSuccessful = true),
                        (this.recentlySuccessful = true),
                        (this.recentlySuccessfulTimeoutId = setTimeout(() => (this.recentlySuccessful = false), 2e3)),
                        (this.response = s.data);
                };
                if (this.action === "#") return i(Object.fromEntries(t));
                p.request(this.action, n, t, { ...r, ...this.headers }, false, this.blob)
                    .then(i)
                    .catch(async (s) => {
                        if (
                            ((this.processing = false),
                            ...
                            (this.recentlyUnsuccessfulTimeoutId = setTimeout(() => (this.recentlyUnsuccessful = false), 2e3)),
                            this.$emit("error", s),
                            !this.scrollOnError)
                        )
                            return;
                        ...
                        a && this.focusAndScrollToElement(this.formElement.querySelector(`[data-validation-key="${a}"]`));
                    });
            },
        },
        render() {
                ...
                new Proxy(
                    {},
                    {
                        ...
                        get(t, r) {
                            ...
                            return r === "$response"
                                ? e.response
                                : n.includes(r) || et(r, "__v_")
                                ? e[r]
                                : (!e.isMounted && !W(e.values, r) && (e.missingAttributes.push(r), e.$put(r, "")), be(e.values, r));
                        },
                        set(t, r, n) {
                            return e.$put(r, n);
                        },
    ...
    Nf = {
        ...
        mounted() {
            (this.element = this.$refs.input.querySelector("input")),
                this.flatpickr && this.initFlatpickr(this.element),
                ...
                import("flatpickr").then((t) => {
                    (this.flatpickrInstance = t.default(
                        ...
                        Object.assign({}, this.flatpickr, this.jsFlatpickrOptions, {
                            onChange: (r, n) => {
                                (this.flatpickrInstance.config.mode === "range" && this.flatpickrInstance.selectedDates.length < 2) ||
...
function Hf(e, t, r, n, i, s) {
    return openBlock(), createElementBlock("div", Vf, [renderSlot(e.$slots, "default", { disabled: i.disabled })], 512);
}
const Uf = /* @__PURE__ */ _e(Nf, [["render", Hf]]),
    Wf = {
        props: {
            options: {
                type: Object,
        ...
        mounted() {
            ...
            import("jodit").then((t) => {
                ...
                (this.instance = t.default.Jodit.make(e, r)),
                    (this.instance.value = this.modelValue),
                    this.instance.events.on("change", (n) => this.$emit("update:modelValue", n)),
                    this.dusk && this.instance.editor.setAttribute("dusk", this.dusk);
            });
        },
        beforeUnmount() {
...
function Gf(e, t, r, n, i, s) {
    return openBlock(), createElementBlock("div", zf, [renderSlot(e.$slots, "default")], 512);
}
const Xf = /* @__PURE__ */ _e(Wf, [["render", Gf]]),
    Kf = {
        ...
        methods: {
            async request() {
                (this.html = null),
                    p.lazy(this.url, this.name).then((e) => {
...
const Qf = /* @__PURE__ */ _e(Kf, [["render", Jf]]),
    Yf = ["href", "onClick"],
    Zf = {
        __name: "Link",
        props: {
        ...
        setup(e) {
            const t = e,
                ...
                n = ref(null);
            function i() {
                if (((n.value = null), !t.confirm)) return s();
                p.confirm(
            ...
            function s() {
                if (t.away) return (window.location = t.href);
                const o = r > 0 && t.keepModal;
                if (t.modal && !o) return p.modal(t.href);
                if (t.slideover && !o) return p.slideover(t.href);
                if (et(t.href, "#")) {
                    if (p.openPreloadedModal(t.href.substring(1))) return;
                ...
                if (
                    (o && ((u["X-Splade-Modal"] = p.stackType(r)), (u["X-Splade-Modal-Target"] = r)),
                    t.preserveScroll && (u["X-Splade-Preserve-Scroll"] = true),
                    l === "GET")
                )
                    return t.replace ? p.replace(t.href, u) : p.visit(t.href, u);
                const c = t.data instanceof FormData ? t.data : pn(t.data);
                l !== "POST" && (c.append("_method", l), (l = "POST")),
                    n.value && (c.append(se(t.requirePassword) && t.requirePassword ? t.requirePassword : "password", n.value), (n.value = null)),
                    p.request(t.href, l, c, u, t.replace);
            }
            return (a, o) => (
                openBlock(),
                createElementBlock(
    ...
    rp = {
        ...
        methods: {
            async request() {
                (this.loading = true),
                    p.rehydrate(this.url, this.name).then((e) => {
...
function np(e, t, r, n, i, s) {
    ...
    return i.html
        ...
        : i.loading
        ? renderSlot(e.$slots, "placeholder", { key: 1 })
        : renderSlot(e.$slots, "default", { key: 2 });
}
const ip = /* @__PURE__ */ _e(rp, [["render", np]]),
    sp = {
        props: {
            script: {
                type: String,
...
const op = {
            ...
            hasSelection() {
                return this.multiple
                    ? Array.isArray(this.modelValue)
                        ...
                        : false
                    : !(this.modelValue === null || this.modelValue === "" || this.modelValue === void 0);
            },
        },
        watch: {
            modelValue(e, t) {
                ...
                if (this.choicesInstance) {
                    if (JSON.stringify(e) == JSON.stringify(t)) return;
        ...
        methods: {
            async setOptionsFromRemote(e) {
                ...
                var r,
                    n = this.element.options.length - 1;
                for (r = n; r >= 0; r--) this.element.remove(r);
                let i = false;
                if (
                    (te(t, (s) => {
                        ...
                        (a.value = s.value),
                            (a.text = s.label),
                            s.value === `${this.modelValue}` && s.value !== "" && (i = true),
                            s.disabled && (a.disabled = s.disabled),
                            s.placeholder && (a.placeholder = s.placeholder),
                            this.element.appendChild(a);
                    }),
                    this.resetOnNewRemoteUrl && (i = false),
            ...
            destroyChoicesInstance() {
                ...
                this.choices &&
                    ...
                    (this.headlessListener &&
                        ((e = document.querySelector("#headlessui-portal-root")) == null ||
                            e.removeEventListener("click", this.headlessListener, { capture: true }),
                        (this.headlessListener = null)),
                    this.selectChangeListener && this.element.removeEventListener("change", this.selectChangeListener),
                    this.selectShowDropdownListener && this.element.removeEventListener("showDropdown", this.selectShowDropdownListener),
            ...
            setValueOnChoices(e) {
                Array.isArray(e) && ((e = ws(e, (t) => `${t}`)), this.choicesInstance.removeActiveItems()),
                    e == null ? (e = "") : Array.isArray(e) || (e = `${e}`),
                    this.choicesInstance.setChoiceByValue(e),
            ...
            handlePlaceholderVisibility() {
                ...
                const e = this.choicesInstance.containerInner.element.querySelector("input.choices__input");
                this.placeholderText = e.placeholder ? e.placeholder : this.placeholderText;
                const t = this.choicesInstance.getValue().length;
                (e.placeholder = t ? "" : this.placeholderText ? this.placeholderText : ""),
                    (e.style.minWidth = "0"),
                    (e.style.width = t ? "1px" : "auto"),
                    (e.style.paddingTop = t ? "0px" : "1px"),
                    (e.style.paddingBottom = t ? "0px" : "1px");
            },
            initChoices(e) {
                return new Promise((t) => {
                    const r = Array.from(e.querySelectorAll("option:not([placeholder])")).length,
                        n = this;
                    import("choices.js").then((i) => {
                        const s = Object.assign({}, this.choices, this.jsChoicesOptions, {
                            callbackOnInit: function () {
                                const a = this;
                                n.stack > 0 &&
                                    ((n.headlessListener = function (o) {
                                        if (!n.choicesInstance) return;
                                        const l = n.choicesInstance.dropdown.isActive,
                                            u = n.choicesInstance.containerOuter.element.contains(o.target);
                                        !l && u ? n.choicesInstance.showDropdown() : l && !u && n.choicesInstance.hideDropdown();
                                    }),
                                    document.querySelector("#headlessui-portal-root").addEventListener("click", n.headlessListener, { capture: true })),
                                    a.containerInner.element.setAttribute("data-select-name", e.name),
                                    e.hasAttribute("dusk") && e.removeAttribute("dusk"),
                                    n.dusk &&
                                        (a.containerInner.element.setAttribute("dusk", n.dusk), a.choiceList.element.setAttribute("dusk", `${n.dusk}-listbox`)),
                                    (n.selectChangeListener = function () {
                                        let o = a.getValue(true);
                                        if ((o == null && (o = ""), n.$emit("update:modelValue", o), !n.multiple || r < 1)) return;
                                        a.getValue().length >= r && a.hideDropdown();
                                    }),
                                    e.addEventListener("change", n.selectChangeListener),
                                    a.containerInner.element.addEventListener("hideDropdownFromDusk", function () {
                                        a.hideDropdown();
                                    }),
                                    (n.selectShowDropdownListener = function () {
                                        if (n.multiple || !n.modelValue) return;
                                        const o = n.getItemOfCurrentModel(),
                                            l = a.dropdown.element.querySelector(`.choices__item[data-id="${o.id}"]`);
                                        a.choiceList.scrollToChildElement(l, 1), a._highlightChoice(l);
                                    }),
                                    e.addEventListener("showDropdown", n.selectShowDropdownListener),
                                    (n.choicesInstance = a),
                                    n.setValueOnChoices(n.modelValue),
                                    t();
                            },
                        });
                        new i.default(e, s);
            ...
            updateHasSelectionAttribute() {
                this.choicesInstance.containerInner.element.setAttribute("data-has-selection", this.hasSelection);
            },
        },
    },
    lp = { ref: "select" };
function up(e, t, r, n, i, s) {
    return openBlock(), createElementBlock("div", lp, [renderSlot(e.$slots, "default", { loading: i.loading })], 512);
}
const cp = /* @__PURE__ */ _e(op, [["render", up]]),
    dp = {
        inject: ["stack"],
        render() {
            const e = p.validationErrors(this.stack),
                t = p.flashData(this.stack),
                r = p.sharedData.value,
                n = ys(e, (i) =>
                    i.join(`
`)
                );
...
const mp = {
        ...
        mounted() {
            const e = this.getCurrentQuery(),
                t = e.columns || [];
            te(e, (r, n) => {
                if (et(n, "filter[") && !r) {
                    const i = n.split("["),
                        s = i[1].substring(0, i[1].length - 1);
                ...
                p.restore(this.scrollToHeadRememberKey) &&
                    this.$nextTick(() => {
        ...
        methods: {
            navigate(e, t) {
                ...
                (this.paginationScroll !== "top" || !t) && (r["X-Splade-Preserve-Scroll"] = true),
                    p.request(e, "GET", {}, r, false).then(() => {
            ...
            visitLink(e, t, r) {
                ...
                if (
                    !(
                        ((n = r == null ? void 0 : r.target) == null ? void 0 : n.tagName) === "A" ||
                        ((i = r == null ? void 0 : r.target) == null ? void 0 : i.tagName) === "BUTTON"
                    )
                )
            ...
            toggleColumn(e) {
                const t = !this.columnIsVisible(e),
                    r = hp(this.columns, (i) => (i.can_be_hidden ? (i.key === e ? t : this.visibleColumns.includes(i.key)) : true));
                let n = ws(r, (i) => i.key).sort();
                ii(n, this.defaultVisibleToggleableColumns) && (n = []),
                    (this.visibleColumns = n.length === 0 ? this.defaultVisibleToggleableColumns : n),
                    this.updateQuery("columns", n, null, false);
            },
            ...
            showSearchInput(e) {
                (this.forcedVisibleSearchInputs = [...this.forcedVisibleSearchInputs, e]),
                    nextTick(() => {
                ...
                return (
                    e
                        ...
                        .forEach((r) => {
                            ...
                            const s = i.split("["),
                                a = s[1].substring(0, s[1].length - 1);
            ...
            visitWithQueryObject(e, t, r) {
                ...
                if (!r) return this.stack > 0 ? void 0 : p.replaceUrlOfCurrentPage(s);
                this.isLoading = true;
                let a = null;
...
function gp(e, t, r, n, i, s) {
    return withDirectives(
        (openBlock(),
        createBlock(
            resolveDynamicComponent(i.isMounted ? i.Teleport : "div"),
...
const yp = /* @__PURE__ */ _e(vp, [["render", gp]]),
    bp = {
        props: {
            autosize: {
                type: Boolean,
        ...
        watch: {
            modelValue() {
                !this.autosize ||
                    !this.autosizeInstance ||
                    import("autosize").then((e) => {
...
function Sp(e, t, r, n, i, s) {
    return openBlock(), createElementBlock("div", wp, [renderSlot(e.$slots, "default")], 512);
}
const Op = /* @__PURE__ */ _e(bp, [["render", Sp]]),
    $p = {
        props: {
            toastKey: {
                type: Number,
    ...
    Ep = ["left-top", "center-top", "right-top", "left-center", "center-center", "right-center", "left-bottom", "center-bottom", "right-bottom"],
    Tp = {
        computed: {
            toasts: function () {
                    ...
                    {},
                    {
                        ...
                        get(t, r) {
                            ...
                            if (n.length === 1 && cs(n) === "default") {
                                if (r === "toggled") return e.toggled("default");
                                if (r === "setToggle")
                                    return (i) => {
            ...
            return (
                this.methods.forEach((r) => {
                    t[r] = async (...n) => {
                        ...
                        return (
                            (this.instance = i.data.instance),
                            (this.signature = i.data.signature),
                            te(i.data.data, (s, a) => {
                                St(this.values, a, s);
                            }),
                            i.data.redirect
                                ? p.visit(i.data.redirect)
                                : (i.data.toasts.forEach((s) => {
                                      p.pushToast(s);
                                  }),
                                  i.data.result)
                        );
  ...
  `),
        ...
        init(e) {
            ...
            import("nprogress").then((r) => {
                ...
                document.addEventListener("splade:internal:request-progress", (s) => t.progress(s, r.default)),
                    document.addEventListener("splade:internal:request-response", (s) => i(s)),
                    document.addEventListener("splade:internal:request-error", (s) => i(s)),
                    r.default.configure({ showSpinner: e.spinner }),
                    e.css && this.injectCSS(e.color);
            });
        },
    },
    Fp = {
        install: (e, t) => {
            (t = t || {}),
                (t.max_keep_alive = W(t, "max_keep_alive") ? t.max_keep_alive : 10),
                (t.prefix = W(t, "prefix") ? t.prefix : "Splade"),
                (t.transform_anchors = W(t, "transform_anchors") ? t.transform_anchors : false),
                (t.link_component = W(t, "link_component") ? t.link_component : "Link"),
                (t.progress_bar = W(t, "progress_bar") ? t.progress_bar : false),
                (t.components = W(t, "components") ? t.components : {}),
                (t.view_transitions = W(t, "view_transitions") ? t.view_transitions : false),
                (t.suppress_compile_errors = W(t, "suppress_compile_errors") ? t.suppress_compile_errors : false);
            const r = t.prefix;
            if (
                (e
                    .component(`${r}Button`, Ul)
                    .component(`${r}Confirm`, Bu)
                    .component(`${r}DataStores`, Uu)
                    .component(`${r}Data`, Hu)
                    .component(`${r}Defer`, nc)
                    .component(`${r}Dialog`, ic)
                    .component(`${r}Dropdown`, ud)
                    .component(`${r}DynamicHtml`, cd)
                    .component(`${r}Errors`, dd)
                    .component(`${r}Event`, fd)
                    .component(`${r}File`, Bf)
                    .component(`${r}Flash`, jf)
                    .component(`${r}Form`, Df)
                    .component(`${r}Input`, Uf)
                    .component(`${r}JoditEditor`, Xf)
                    .component(`${r}VueBridge`, Ip)
                    .component(`${r}Lazy`, Qf)
                    .component(`${r}Modal`, ep)
                    .component(`${r}OnClickOutside`, rs)
                    .component(`${r}PreloadedModal`, tp)
                    .component(`${r}Rehydrate`, ip)
                    .component(`${r}Render`, ue)
                    .component(`${r}Script`, sp)
                    .component(`${r}Select`, cp)
                    .component(`${r}State`, dp)
                    .component(`${r}Table`, mp)
                    .component(`${r}Teleport`, yp)
                    .component(`${r}Textarea`, Op)
                    .component(`${r}Toast`, $p)
                    .component(`${r}Toasts`, Tp)
                    .component(`${r}Toggle`, xp)
                    .component(`${r}Transition`, _p)
                    .component(t.link_component, Zf)
                    .directive(`${r}PreserveScroll`, Ap),
                Object.defineProperty(e.config.globalProperties, "$splade", { get: () => p }),
                Object.defineProperty(e.config.globalProperties, "$spladeOptions", { get: () => Object.assign({}, { ...t }) }),
                e.provide("$splade", e.config.globalProperties.$splade),
                e.provide("$spladeOptions", e.config.globalProperties.$spladeOptions),
                t.progress_bar)
            ) {
                const n = {
                    delay: 250,
                ...
                J(t.progress_bar) || (t.progress_bar = {}),
                    ["delay", "color", "css", "spinner"].forEach((i) => {
                        W(t.progress_bar, i) || (t.progress_bar[i] = n[i]);
                    }),
                    Cr.init(t.progress_bar);
            }
            t.suppress_compile_errors &&
                (e.config.compilerOptions.onError = (n) => {
                    import("./assets/CompilerErrorMessages-4a55bbec.6f4225bf.mjs").then((i) => {
                        console.error({
...
const _sfc_main$2 = {
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(`<pre${ssrRenderAttrs(mergeProps(_ctx.$attrs, _attrs))}><!--[-->`);
            ssrRenderList(html.value.spans, (span, index) => {
                _push(`<span style="${ssrRenderStyle(span.css)}">${span.text}</span>`);
            });
            _push(`<!--]--> </pre>`);
        };
    },
...
_sfc_main$2.setup = (props, ctx) => {
    ...
    (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Ansicolor.vue");
...
_sfc_main$1.setup = (props, ctx) => {
    const ssrContext = useSSRContext();
    (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/CopyToClipboard.vue");
    return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const prismeditor_min = "";
const prism = "";
...
_sfc_main.setup = (props, ctx) => {
    const ssrContext = useSSRContext();
    (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/PrismEditor.vue");
...
kp(createServer, renderToString, (props) => {
    return createSSRApp({
        ...
        .component("Ansicolor", _sfc_main$2)
        .component("CopyToClipboard", _sfc_main$1)
        .component("PrismEditor", _sfc_main)
        .use(Fp);
});
